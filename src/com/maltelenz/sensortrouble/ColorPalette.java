...
public class ColorPalette {
    public static int background = Color.rgb(196, 246, 255);
    public static int button = Color.rgb(0, 132, 156);

    public static int progress = Color.rgb(169, 222, 51);
    public static int inactiveProgress = Color.argb(100, 169, 222, 51);

    public static int progressBackground = Color.argb(20, 199, 244, 100);

    public static int darkText = Color.rgb(0, 132, 156);
    ...
    public static int laser = Color.rgb(232, 110, 35);
